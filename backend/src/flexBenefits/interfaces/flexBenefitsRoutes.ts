...
import {authorize,bindOwnCollaborator,scopeOwnCollaborator} from '../../middleware/authorization.js';
...
router.post('/reembolsos',authorize('benefits.self'),upload.single('comprovante'),bindOwnCollaborator('benefits.self'),controller.reimburse);
