...
router.get('/processamentos/:id/esocial/eventos', authorize('payroll.read'), controller.esocialEvents);
router.post('/processamentos/:id/esocial/fechar', authorize('payroll.run'), controller.closeEsocial);
