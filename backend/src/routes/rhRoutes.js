...
r.get('/funcionarios', authorize('employee.read.basic', 'employee.read.all', 'employee.read'), c.funcionarios);
...
r.get('/ferias', authorize('time.manage.team','time.manage.all'), c.feriasList);
r.post('/ferias', authorize('time.manage.team','time.manage.all'), c.feriasPost);
r.patch('/ferias/:id/aprovar', authorize('time.manage.team','time.manage.all'), c.feriasAprovar);
r.patch('/ferias/:id/reprovar', authorize('time.manage.team','time.manage.all'), c.feriasReprovar);
r.patch('/ferias/:id/encerrar', authorize('time.manage.all'), c.feriasEncerrar);
